  ...
  <>
    <SectionWrapper initial="hidden" animate="visible" variants={fadeIn}>
      ...
      <List>
        ...
        <ListItem>People Related to the Automotive Industry</ListItem>
        <ListItem>Suppliers of trim levels, options, and performance packages</ListItem>
        <ListItem>Race Track and Automotive Sport venues and people that race, past and present.</ListItem>
      ...
      <Paragraph>
        <h2><b>Internet Software Technologies</b></h2>
    ...
    <h2>References</h2>
    <ul>
      <li><a href="https://www.TheCorvetteReporter.com/" target="_blank" rel="noopener noreferrer">The Corvette Reporter</a></li>
